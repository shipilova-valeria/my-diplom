...
(1, 'Настроить роли доступа', 'RBAC для модулей CRM', 'todo', 'high', NULL, '2026-05-18'),
(1, 'Интеграция с 1С', 'API обмен данными', 'todo', 'medium', NULL, '2026-05-22'),
(1, 'Дизайн главной страницы', 'Макеты Figma', 'todo', 'low', 10, '2026-05-25'),
(1, 'Миграция БД', 'Скрипты миграции', 'todo', 'high', 8, '2026-05-20'),
(1, 'API авторизации', 'JWT + refresh tokens', 'in_progress', 'high', 8, '2026-05-16'),
(1, 'Канбан-доска', 'Drag and drop задач', 'in_progress', 'medium', 10, '2026-05-19'),
(1, 'Unit-тесты API', 'Покрытие 80%', 'in_progress', 'medium', 8, '2026-05-21'),
(1, 'Ревью UI компонентов', 'Code review', 'in_review', 'medium', 12, '2026-05-17'),
(1, 'Тестирование форм', 'QA регресс', 'in_review', 'low', 12, '2026-05-18'),
(1, 'Настройка CI/CD', 'GitHub Actions', 'done', 'medium', 8, '2026-05-10'),
(1, 'Инициализация репозитория', 'Monorepo setup', 'done', 'low', 8, '2026-05-05'),
(1, 'Документация API', 'Swagger', 'done', 'low', NULL, '2026-05-12');
